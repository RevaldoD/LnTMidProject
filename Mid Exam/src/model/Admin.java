...
public class Admin extends Jabatan{
	...
	private static final double bonusRaise = 5;
	
	public Admin(String karyawanID, String namaKaryawan, String jenisKelamin, String jabatanKaryawan) {
		super(karyawanID, namaKaryawan, jenisKelamin, jabatanKaryawan, 4000000);
	...
	public static void evaluateBonus(Vector<Jabatan> karyawanMusang) {
		if (counter % 3 == 1 && counter != 1) {
			...
			for (int i = 0; i < karyawanMusang.size(); i++) {
				if (karyawanMusang.get(i) instanceof Admin) {
