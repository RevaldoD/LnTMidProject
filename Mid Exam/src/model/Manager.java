...
public class Manager extends Jabatan{
	...
	private static final double bonusRaise = 10;

	public Manager(String karyawanID, String namaKaryawan, String jenisKelamin, String jabatanKaryawan) {
		super(karyawanID, namaKaryawan, jenisKelamin, jabatanKaryawan, 8000000);
	...
	public static void evaluateBonus(Vector<Jabatan> karyawanMusang) {
		if (counter % 3 == 1 && counter != 1) {
			...
			for (int i = 0; i < karyawanMusang.size(); i++) {
				if (karyawanMusang.get(i) instanceof Manager) {
